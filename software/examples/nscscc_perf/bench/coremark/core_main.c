...
unsigned long start_count_coremark = 0;
unsigned long stop_count_coremark = 0;
unsigned long total_count_coremark = 0;

unsigned long start_count_my_coremark = 0;
unsigned long stop_count_my_coremark  = 0;
unsigned long total_count_my_coremark = 0;
...
#error "Please define a way to initialize a memory block."
	...
	start_ns = get_ns();
	start_count_coremark = get_count();
    start_count_my_coremark = get_count_my();
...
#endif
	//stop_time();
	stop_count_my_coremark  = get_count_my();
    stop_count_coremark     = get_count();
	stop_ns = get_ns();
	total_count_coremark    = stop_count_coremark - start_count_coremark;
    total_count_my_coremark = stop_count_my_coremark - start_count_my_coremark;
	total_ns = stop_ns-start_ns;
	total_time=total_count_my_coremark;
