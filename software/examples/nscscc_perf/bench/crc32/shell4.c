...
extern unsigned long start_count_crc32;
extern unsigned long stop_count_crc32;
extern unsigned long total_count_crc32;

extern unsigned long start_count_my_crc32;
extern unsigned long stop_count_my_crc32;
extern unsigned long total_count_my_crc32;
...
void shell4(void)
{
    ...
    SOC_NUM = total_count_my_crc32;  
    *((volatile unsigned *)CONFREG_CR0) = total_count_my_crc32;  
    *((volatile unsigned *)CONFREG_CR1) = total_count_crc32;  
	printf("crc32: Total Count(SoC count) = 0x%x\n", total_count_crc32);
	printf("crc32: Total Count(CPU count) = 0x%x\n", total_count_my_crc32);
