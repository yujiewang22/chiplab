...
unsigned long start_count_dhry = 0;
unsigned long stop_count_dhry = 0;
unsigned long total_count_dhry = 0;

unsigned long start_count_my_dhry = 0;
unsigned long stop_count_my_dhry  = 0;
unsigned long total_count_my_dhry = 0;
...
//  Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
  ...
  Begin_Time = get_ns();
  start_count_dhry = get_count();
  start_count_my_dhry = get_count_my();
  ...
  /* Stop timer */
  /**************/
  stop_count_my_dhry  = get_count_my();
  stop_count_dhry     = get_count();
  End_Time = get_ns();
  total_count_dhry    = (stop_count_dhry - start_count_dhry);
  total_count_my_dhry = (stop_count_my_dhry - start_count_my_dhry);
  ...
  else
  {
    ...
    DMIPS_MHZ = (1000000/((float)total_count_my_dhry/(float)Number_Of_Runs))/1757;
